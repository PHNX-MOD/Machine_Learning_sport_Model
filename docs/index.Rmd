...
Pulled from the database here is the cleaned table within the query(RSQLite). Please use Show/Hide to display the code.
...
Further the table is cleaned using dplyr
